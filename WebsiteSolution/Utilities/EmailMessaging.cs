...
namespace Group5_FinalProject_v2.Utilities
{
    public static class EmailMessaging
    {
        public static void SendEmail(String emailSubject, String emailBody)
        {
            ...
            String strFromEmailAddress = "fa23group5mis333k@gmail.com";
            ...
            String strPassword = "tnrqojparcskpclm";

            //This is the name of the business from which you are sending
            String strCompanyName = "Longhorn Cinema";
            ...
            String finalMessage = emailBody + "- Longhorn Cinema";
